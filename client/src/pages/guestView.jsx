...
import NavbGuest from "../assets/NavbarGuest";
        ...
        <div className="pt-20 lg:hidden"></div>
          ...
          <div className="flex flex-col w-full gap-3 h-full scroller lg:gap-4">
            <div onClick={handleCreateBoard} className="card bg-[#404664] w-full hover:bg-[#404664]/80">
              <div className="flex items-center justify-start items-center p-5 cursor-pointer gap-3 lg:gap-2">
                <img
                  src="UK.svg"
                  className="size-8 rounded-full lg:mr-8 lg:size-12"
                />
                <div className="flex items-center text-sm text-white/60 lg:text-lg">What’s on your mind, Guest</div>
              </div>
            </div>
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 px-8">
          <div className="bg-[#282C45] border border-[#404664] p-4 rounded-2xl  flex flex-col items-center relative gap-5 w-full lg:w-2/5 h-3/5 lg:p-[30px]">
            ...
            <div className="flex flex-col  justify-center items-center w-full h-full  bg-whtie">
                <div className="text-orange text-5xl pb-8 font-bold">oops !!! </div>
                <img src="loginError.svg" alt="" />
                <a href="/login" className="text-white/50 pt-8 tracking-wide hover:text-orange-400">Please login before " Rabai "</a>
            </div>
          </div>
        </div>
      )}
