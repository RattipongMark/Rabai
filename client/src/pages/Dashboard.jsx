    ...
    <Bg>
      <Navb />
        <div className='justify-center p-28'>
          ...
          <div className='space-y-4 overflow-y-auto p-6 h-[700px] scroller'>
            ...
            <div className="card bg-[#404664] p-6 lgt-txt w-full space-y-4">
              <div className="flex items-center">
                <img src="./profilegoose2.svg" className="w-12 h-12 rounded-full mr-8" />
                <div>
                  <p className="font-semibold">The duck of hell</p>
                  <p className="text-gray-400 text-sm">1 h ago</p>
                </div>
                <div className="ml-auto">
                  <span className="bg-[#E1F3FF] text-xs font-semibold text-[#0095FF] px-5 py-0.5 rounded-full">CPE</span>
                </div>
              </div>

              <p className="lgt-txt text-sm leading-relaxed">
                Lorem ipsum dolor sit amet. Sed voluptas beatae id ducimus doloremque et sunt dolor et quia tempore et deleniti explicabo a magnam voluptatem. Cum dolorum sint sit nemo fugiat in commodi incidunt sit exercitationem dolor in velit quaerat.
              </p>
